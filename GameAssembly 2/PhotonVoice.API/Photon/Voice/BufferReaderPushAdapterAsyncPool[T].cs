...
{
	public class BufferReaderPushAdapterAsyncPool<T> : BufferReaderPushAdapterBase<T> // TypeDefIndex: 4718
	{
		// Constructors
		public BufferReaderPushAdapterAsyncPool() {} // Dummy constructor
